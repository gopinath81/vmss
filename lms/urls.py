...
urlpatterns += (
    url(r'^programs/$', 'learner_dashboard.views.program_listing_marketing', name='program_listing_view_marketing'),
    # Matches paths like 'programs/123/' and 'programs/123/foo/', but not 'programs/123/foo/bar/'. Also accepts strings that look like UUIDs, to support
    # retrieval of catalog-based MicroMasters.
    url(r'^programs/(?P<program_id>[0-9a-f-]+)/[\w\-]*/?$', 'learner_dashboard.views.program_details_marketing', name='program_details_view_marketing'),
)
