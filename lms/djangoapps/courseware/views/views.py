...
def course_about(request, course_id):
    ...
    with modulestore().bulk_operations(course_key):
        ...
        log.error("registration_price %s" %registration_price)
        log.error("course_price %s" %course_price)
        log.error("_is_shipping_cart_enabled %s" %_is_shopping_cart_enabled)
        log.error("ecommerce_checkout_link %s" %ecommerce_checkout_link)
        ...
        log.error("can_add_course_to_cart %s" %can_add_course_to_cart)
        log.error("register_link %s" %reg_then_add_to_cart_link)
